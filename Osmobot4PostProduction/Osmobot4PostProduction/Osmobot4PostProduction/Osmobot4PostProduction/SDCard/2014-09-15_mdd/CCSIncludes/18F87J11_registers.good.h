...
typedef struct 
 {
   union {
      struct {
         unsigned int :1;
         unsigned int ADMSK0:1;
         unsigned int ADMSK1:1;
         unsigned int ADMSK2:1;
         unsigned int ADMSK3:1;
         unsigned int ADMSK5:1;
      };
...
ANCON1BITS ANCON1bits;
#byte ANCON1bits = 0xFC2
#byte ANCON1 = 0xFC2
...
typedef union 
 {
   union {
      struct {
         ...
         unsigned int PSS1AC0:1;
         unsigned int PSS1AC1:1;
         unsigned int ECCP1AS0:1;
         unsigned int ECCP1AS1:1;
         unsigned int ECCP1AS2:1;
...
typedef union 
 {
   union {
      struct {
         ...
         unsigned int PSS2AC0:1;
         unsigned int PSS2AC1:1;
         unsigned int ECCP2AS0:1;
         unsigned int ECCP2AS1:1;
         unsigned int ECCP2AS2:1;
...
typedef union 
 {
   union {
      struct {
         ...
         unsigned int PSS3AC0:1;
         unsigned int PSS3AC1:1;
         unsigned int ECCP3AS0:1;
         unsigned int ECCP3AS1:1;
         unsigned int ECCP3AS2:1;
...
typedef struct 
 {
   union {
      ...
      struct {
         ...
         unsigned int DC3B0:1;
         unsigned int DC3B1:1;
         unsigned int P3M0:1;
         unsigned int P3M1:1;
      };
   };
...
typedef struct 
 {
   unsigned int COUT0:1;
   unsigned int COUT2:1;
} CMSTATBITS;
...
typedef union 
 {
      struct {
         unsigned int ADDRH0:1;
         unsigned int ADDRH1:1;
         unsigned int ADDRH2:1;
         unsigned int ADDRH3:1;
         unsigned int ADDRH4:1;
         unsigned int ADDRH5:1;
         unsigned int CS6:1;
         unsigned int CS2:1;
      };
      struct {
