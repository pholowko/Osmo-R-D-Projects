...
char teststr4[20]="TEST1234";
char teststr1[20]="Hello World!";
char teststr2[20]="You Farted";
char teststr3[20]="LCD Test";

writeString(1,1,teststr1);
writeString(4,2,teststr2);
writeString(0,3,teststr3);
writeString(1,1,teststr4);
}
